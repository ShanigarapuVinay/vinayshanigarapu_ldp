...
public class StudentStream {
    public static void main(String[] args) {
        ...
        List<Student> allStudents = students.stream()
                                    .filter(student -> student.getGender().equals("Female") && String.valueOf(student.getId()).contains("1")
                                            || (student.getGender().equals("Male") && String.valueOf(student.getId()).contains("2")))
